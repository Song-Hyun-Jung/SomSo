...
public class EndDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into " + TABLE_END + " values (null, '수고했어, 오늘도.\n내일 또 보자!');");
        db.execSQL("insert into " + TABLE_END + " values (null, '내일도 또 얘기하자!');");
        db.execSQL("insert into " + TABLE_END + " values (null, '오늘 힘들었지?\n오늘은 이만 푹 쉬어!');");
        db.execSQL("insert into " + TABLE_END + " values (null, '오늘 하루도 잘 지낸 너가 자랑스러워!\n내일도 파이팅!');");
        db.execSQL("insert into " + TABLE_END + " values (null, '오늘 고생했어!\n나는 네 편이라는 걸 잊지마!\n내일 봐!');");
        ...
        db.execSQL("insert into " + TABLE_END + " values (null, '나를 만나러 와줘서 고마워!\n내일도 만나러 와!');");
        db.execSQL("insert into " + TABLE_END + " values (null, '내일도 여기에서\n 널 기다리고 있을게!\n안녕!');");
    }
    @Override
