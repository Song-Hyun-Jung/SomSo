...
public class DialogueDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into " + TABLE_DIALOGUE + " values (null, '요즘 힘들었던 일 많았어?', '최근에 가장 힘들었던 순간은?', '어떤 게 너를 힘들게 했어?', '지금은 괜찮아?', '그렇구나... 이 일을 통해서 어떤 걸 느꼈어?', '앞으로 비슷한 상황을 마주한다해도 너는 이겨낼 수 있을거야!', 0);");
        db.execSQL("insert into " + TABLE_DIALOGUE + " values (null, '최근에 가장 즐거웠던 순간은 언제야?', '그 순간에 어울리는 노래를 뽑는다면 어떤 노래가 좋을까?', '잘 어울릴 것 같아! 그때를 회상하면서 그 노래를 들어보는 건 어때? 기분이 좋아질거야!', '앞으로 일정 중에 기대되는 거 있어?', '그게 왜 가장 기대돼?', '오~ 기대되겠다!', 0);");
        ...
        db.execSQL("insert into " + TABLE_DIALOGUE + " values (null, '최근에 통화한 적 있어?', '즐거운 대화였어?', '지금 누군가와 통화하고 싶지는 않아?', '전화로 무슨 얘기 하고 싶어?', '누군가에게 전화 걸어보는건 어때?', '그 사람도 너의 전화를 기다리고 있을거야!', 0);");
        db.execSQL("insert into " + TABLE_DIALOGUE + " values (null, '최근에 상상같은거 해봤어?', '어떤 상상이었어?', '그 상상이 현실이 된다면 어떨 것 같아?', '평소에 상상하는 거 좋아해?', '만약 지금 시간 여행을 한다면 언제로 가고 싶어?', '이유도 알려줘!', 0);");
        db.execSQL("insert into " + TABLE_DIALOGUE + " values (null, '다가오는 특별한 날이 있어?', '있다면 그날에 뭐할거야?', '누구랑 같이 보낼거야?', '기념일에 좋은 추억이 있다면 어떤 거야?', '일주일 뒤에 너는 뭘 하고 있을지 생각해봤어?', '일주일 계획을 세워봐!', 0);");
        ...
        db.execSQL("insert into " + TABLE_DIALOGUE + " values (null, '요즘 뭐하고 지내?', '심심하진 않아?', '취미활동 해보는 건 어때? 짧게라도 괜찮아!', '요즘 보석십자수나 피포페인팅 같은 것들이 유행이더라고! 해본 적 있어?', '한번 해보는 건 어때? 재밌을거야!', '그림이나 낙서도 스트레스 해소에 좋을 것 같아!', 0);");
        db.execSQL("insert into " + TABLE_DIALOGUE + " values (null, '창밖은 바라봤어?', '날씨는 어때?', '어떤 게 있었어?', '나가고 싶어지지 않아? 나가서 동네 한바퀴 돌고 오는 건 어때?', '바깥 공기를 마시면 기분이 좋아질거야!', '자전거나 킥보드 같은 거도 타봐!', 0);");
        db.execSQL("insert into " + TABLE_DIALOGUE + " values (null, '청소는 얼마나 자주 하고 있어?', '환기도 해주고 있지?', '심심하다면 주변이라도 살짝 정리해봐!', '정리할 땐 귀찮아도 하고 나면 깔끔하고 뿌듯할 거야!', '혹시 방 안 가구 배치를 바꾸거나 새로운 소품을 놓을 생각은 없어?', '버리고 싶은 물건이나 팔고 싶은 물건은 없어?', 0);");
        db.execSQL("insert into " + TABLE_DIALOGUE + " values (null, '요즘 하고 있는 공부 있어?', '그 공부를 시작하게 된 계기는 뭐야?', '우와 대단하다 어떻게 공부하고 있어?', '지루하다면 새로운 걸 시도해보는 건 어때?', '또 하고 싶은 공부 있어?', '책도 읽어보는 건 어때?', 0);");
        ...
        db.execSQL("insert into " + TABLE_DIALOGUE + " values (null, '최근에 본 인상깊은 문구 같은 거 있어?', '너에게 도움이 되었니?', '요즘 유행어는 뭐야?', '너도 자주 쓰고 있어?', '너의 좌우명은 어떤 거야?', '그 좌우명을 항상 잊지 않길 바래!', 0);");
        ...
        db.execSQL("insert into " + TABLE_DIALOGUE + " values (null, '여태까지 어떤 헤어스타일 해봤어?', '그 중 어떤 게 제일 마음에 들어?', '혹시 헤어스타일을 바꾸고 싶진 않아?', '어떤 스타일로 바꿔보고 싶어?', '한 번 변화를 줘보는건 어때? 기분 전환에 도움이 될거야!', '어떤 모습으로 바뀔 지 기대된다!', 0);");
        db.execSQL("insert into " + TABLE_DIALOGUE + " values (null, '혹시 지금 잊고 있는 건 없어?', '기억력 향상에 도움되는 걸 해보는건 어때?', '눈건강은 괜찮아?', '눈운동도 해줘!', '지금 잠시 폰을 내려놓고 눈 세바퀴 돌리고 오자!', '어때? 눈이 좀 더 잘 보이는 거 같지 않아?', 0);");
    }
